...
<div className="modal" role="dialog">
  <div className="modal-box">
    ...
    {stickers.map((sticker, index ) => {
     ...
     return <img loading='lazy' onClick={()=>handleSendSticker(`${'https://baate01.onrender.com'}/pics/${sticker}`)} className="h-24 w-24 cursor-pointer" key={`sticker-${index}`} src={`${'https://baate01.onrender.com'}/pics/${sticker}`} alt={sticker}/>
