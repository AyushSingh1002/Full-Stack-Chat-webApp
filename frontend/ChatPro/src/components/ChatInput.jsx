...
<div className="modal" role="dialog">
  <div className="modal-box">
    ...
    {stickers.map((sticker, index ) => {
     ...
     return <img onClick={()=>handleSendSticker(`${process.env.REACT_APP_BASE_URL}/pics/${sticker}`)} className="h-24 w-24 cursor-pointer" key={`sticker-${index}`} src={`${process.env.REACT_APP_BASE_URL}/pics/${sticker}`} alt={sticker}/>
